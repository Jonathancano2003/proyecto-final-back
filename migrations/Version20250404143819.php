 ...
 */
final class Version20250404143819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE anuncio (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, coche_id INT NOT NULL, estado VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, fecha_publicacion DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE coche (id INT AUTO_INCREMENT NOT NULL, marca VARCHAR(100) NOT NULL, modelo VARCHAR(100) NOT NULL, año INT NOT NULL, kilometraje INT NOT NULL, imagen VARCHAR(255) DEFAULT NULL, descripcion LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
